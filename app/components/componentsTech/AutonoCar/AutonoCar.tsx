        ...
        <section className={styles.CarFeatures}>
            <section className={styles.carDescription}>
                <section>
                    ...
                    <h1>Using groundbreaking perception-enabled sensor technology, the Autono car is a fully driverless vehicle engineered to the highest degree of precision and safety. It’s autonomous driving reimagined.</h1>
                </section>
                <Image src={autonoCar}
                width={675}
                height={840}
